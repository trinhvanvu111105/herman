...
const SlideBar = () => {
    ...
    return (
        <div className='flex flex-col gap-8 px-4 py-4'>
            ...
            <Link to="/search" className='flex items-center gap-4 text-xl font-bold'>
                <BiSearch className='text-3xl' />
                <span>Tìm kiếm</span>
            </Link>

            <Link to="/create-post" className='flex items-center gap-4 text-xl font-bold'>
            ...
            {userIns && userIns.id ? (
                ...
                <Link to="/login" className='flex items-center gap-4 text-xl font-bold'>
